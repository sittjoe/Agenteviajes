...
Object.assign(App, {
    ...
    clearQuoteForm() {
        ...
        this.setInputValue('quote-dates', '');
        this.setInputValue('quote-travelers', '');
    ...
    fillQuoteForm(quote) {
        ...
        this.setInputValue('quote-dates', quote.dates || '');
        this.setInputValue('quote-travelers', quote.travelers || '');
    ...
    getQuoteFromForm() {
        ...
        return {
            ...
            dates: this.getInputValue('quote-dates'),
            travelers: this.getInputValue('quote-travelers'),
